(function () { 
    if (!mstrmojo.plugins.ClusterDendogram) {
        mstrmojo.plugins.ClusterDendogram = {};
    }
    ...
    mstrmojo.plugins.ClusterDendogram.ClusterDendogram = mstrmojo.declare(
        mstrmojo.CustomVisBase,
        null,
        {
            scriptClass: "mstrmojo.plugins.ClusterDendogram.ClusterDendogram",
            cssClass: "clusterdendogram",

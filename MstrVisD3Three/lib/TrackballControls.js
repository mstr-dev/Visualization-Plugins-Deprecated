...
THREE.TrackballControls = function (object, domElement) {
    ...
    this.handleResize = function () {
        ...
        if (this.domElement === document) {
            this.screen.left = 0;
            this.screen.top = 0;
            this.screen.width = VIZ.width;
            this.screen.height = VIZ.height;

        } else {
            this.screen = mstrmojo.all[VIZ.mjid].domNode.getBoundingClientRect();
            // adjustments come from similar code in the jquery offset() function
            var d = mstrmojo.all[VIZ.mjid].domNode.ownerDocument.documentElement;
    ...
    function mousedown(event) {
        ...
        mstrmojo.all[VIZ.mjid].domNode.addEventListener('mousemove', mousemove, false);
        mstrmojo.all[VIZ.mjid].domNode.addEventListener('mouseup', mouseup, false);
    ...
    function mouseup(event) {
        ...
        mstrmojo.all[VIZ.mjid].domNode.removeEventListener('mousemove', mousemove);
        mstrmojo.all[VIZ.mjid].domNode.removeEventListener('mouseup', mouseup);

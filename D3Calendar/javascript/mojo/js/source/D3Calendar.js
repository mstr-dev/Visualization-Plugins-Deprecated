(function () {
    if (!mstrmojo.plugins.D3Calendar) {
        mstrmojo.plugins.D3Calendar = {};
    }
    ...
    mstrmojo.plugins.D3Calendar.D3Calendar = mstrmojo.declare(
        mstrmojo.CustomVisBase,

        null,

        {
            scriptClass: 'mstrmojo.plugins.D3Calendar.D3Calendar',

(function () {
    if (!mstrmojo.plugins.MstrVisCircularHeatChart) {
        mstrmojo.plugins.MstrVisCircularHeatChart = {};
    }

    mstrmojo.requiresCls("mstrmojo.CustomVisBase");

    mstrmojo.plugins.MstrVisCircularHeatChart.MstrVisCircularHeatChart = mstrmojo.declare(
        mstrmojo.CustomVisBase,
        null,
        {
            scriptClass: 'mstrmojo.plugins.MstrVisCircularHeatChart.MstrVisCircularHeatChart',

            cssClass: "mstrviscircularheatchart",

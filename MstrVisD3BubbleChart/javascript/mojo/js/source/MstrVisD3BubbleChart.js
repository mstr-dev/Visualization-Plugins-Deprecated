(function () {
    if (!mstrmojo.plugins.MstrVisD3BubbleChart) {
        mstrmojo.plugins.MstrVisD3BubbleChart = {};
    }
    ...
    mstrmojo.plugins.MstrVisD3BubbleChart.MstrVisD3BubbleChart = mstrmojo.declare(
        mstrmojo.CustomVisBase,
        null,
        {
            scriptClass: "mstrmojo.plugins.MstrVisD3BubbleChart.MstrVisD3BubbleChart",

            cssClass: "mstrvisd3bubblechart",

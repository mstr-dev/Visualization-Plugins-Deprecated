(function () {
    ...
    mstrmojo.plugins.D3Samples.D3Streamgraph = mstrmojo.declare(
        mstrmojo.plugins.D3Samples.D3Base,
        null,
        {
            scriptClass: 'mstrmojo.plugins.D3Samples.D3Streamgraph',
            ...
            plot: function plot() {
                ...
                g.each(function (d) {
                    ...
                    if (e.select(".area").empty()) {
                        ...
                        e.append("svg:text")
                            .attr("x", 12)
                            .attr("transform", function () { return "translate(" + (w - 60) + "," + (h / 2) + ")"; })
                            .attr("dy", "0em");
                    }

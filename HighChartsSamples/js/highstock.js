...
(function () {
		...
		for (var c = "{", d = !1, e, f, g, h, i, k = []; (c = a.indexOf(c)) !== -1; ) {
			...
			if (d) {
				...
				for (h = 0; h < i; h++)
					e = e[g[h]];
				if (f.length)
					f = f.join(":"), g = /\.([0-9])/, h = F.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = Ia(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = ua(f, e)
			}
			k.push(e);
			a = a.slice(c + 1);
			c = (d = !d) ?
			...
			init : function (b) {
				...
				a.each(["cur", "_default", "width", "height", "opacity"], function (a, b) {
					...
					(j = e[b]) && (e[b] = function (c) {
						...
						c = a ? c : this;
						if (c.prop !== "align")
							return d = c.elem, d.attr ? d.attr(c.prop, b === "cur" ? r : c.now) : j.apply(this, arguments)
					})
				});
		...
		return {
			...
			brighten : function (a) {
				if (d)
					...
					var c;
					for (c = 0; c < 3; c++)
						b[c] += I(a * 255), b[c] < 0 && (b[c] = 0), b[c] > 255 && (b[c] = 255)
				}
				return this
			},
			rgba : b,
	...
	Z.prototype = {
		...
		updateShadows : function (a, b) {
			for (var c = this.shadows, d = c.length; d--; )
				c[d].setAttribute(a, a === "height" ? w(b - (c[d].cutHeight || 0), 0) : a === "d" ? this.d : b)
		},
		addClass : function (a) {
			var b = this.element,
			c = W(b, "class") || "";
		...
		align : function (a, b, c) {
			...
			f = e.alignedObjects;
			if (a) {
				if (this.alignOptions = a, this.alignByTranslate = b, !c || Oa(c))
			...
			if (!a) {
				...
				if (b.isSVG) {
					...
					if (Ha && f && f.fontSize === "11px" && d.toPrecision(3) === "16.9")
						a.height = d = 14;
					if (e)
						a.width = M(d * ia(g)) + M(c * da(g)), a.height = M(d * da(g)) + M(c * ia(g))
				}
				this.bBox = a;
				h && (b.cache[h] = a)
			}
		...
		shadow : function (a, b, c) {
			...
			if (a) {
				...
				for (e = 1; e <= i; e++) {
					...
					if (c)
						W(f, "height", w(W(f, "height") - h, 0)), f.cutHeight = h;
		...
		dashstyleSetter : function (a) {
			...
			if (a = a && a.toLowerCase()) {
				...
				for (b = a.length; b--; )
					a[b] = I(a[b]) * this.element.getAttribute("stroke-width");
				a = a.join(",");
	...
	ka.prototype = {
		...
		label : function (a, b, c, d, e, f,
			...
			function k() {
				...
				if (z) {
					if (!u)
						a = s(-G * x), b = h ? -U : 0, n.box = u = d ? m.symbol(d, a, b, n.width, n.height, D) : m.rect(a, b, n.width, n.height, 0, D[$b]), u.attr("fill", Y).add(n);
					u.isImg || u.attr(v({
							width : s(n.width),
							height : s(n.height)
						}, D));
		...
		P.VMLElement = ea = {
			...
			fillSetter : function (a, b, c) {
				...
				if (d === "SPAN")
					...
					c.filled = a !== Y, this.setAttr("fillcolor", this.renderer.color(a, c, b, this))
			},
			opacitySetter : na,
	...
	ea = {
		...
		color : function (a, b, c, d) {
			...
			if (i) {
				...
				if (c === "fill")
					if (i === "gradient")
						c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, x = 'angle="' + (90 - V.atan((m - a) / (n - c)) * 180 / ra) + '"', s();
					else {
						var k = m.r,
						w = k * 2,
						v = k * 2,
				...
				f = Fa(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], $(this.prepVML(h), null, null, b), k = f.get("rgb");
			else {
	...
	Za.prototype = {
		...
		render : function (a, b, c) {
			...
			if (m && G)
				t === "inside" && (G = -G), d.opposite && (G = -G), h = this.getMarkPath(z, y, G, m * D, g, f), n ? n.animate({
					d : h,
					opacity : c
	...
	L.prototype = {
		...
		init : function (a, b) {
			...
			for (f in d)
				A(this, f, d[f]);
			if (this.isLog)
				this.val2lin = Ga, this.lin2val = oa
		},
				...
				if (c.visible || !b.options.chart.ignoreHiddenSeries) {
					...
					if (a.isXAxis) {
						if (d = c.xData, d.length)
							a.dataMin = z(o(a.dataMin, d[0]), Ra(d)), a.dataMax = w(o(a.dataMax, d[0]), Ba(d))
					} else {
						c.getExtremes();
						e = c.dataMax;
						c = c.dataMin;
						if (t(c) && t(e))
							a.dataMin = z(o(a.dataMin, c), c), a.dataMax = w(o(a.dataMax, e), e);
						if (t(d))
							if (a.dataMin >= d)
		...
		setTickPositions : function (a) {
			...
			if (e)
				!a && z(b.min, o(b.dataMin, b.min)) <= 0 && qa(10, 1), b.min = ha(Ga(b.min)), b.max = ha(Ga(b.max));
			if (b.range && t(b.max))
				b.userMin = b.min = w(b.min, b.max - b.range), b.userMax = b.max, b.range = null;
			b.beforePadding && b.beforePadding();
			b.adjustForMinRange();
			if (!u && !b.axisPointRange && !b.usePercentage && !h && t(b.min) && t(b.max) &&
				(c = b.max - b.min)) {
				if (!t(d.min) && !t(b.userMin) && j && (b.dataMin < 0 || !b.ignoreMinPadding))
					b.min -= c * j;
				if (!t(d.max) && !t(b.userMax) && k && (b.dataMax > 0 || !b.ignoreMaxPadding))
					b.max += c * k
			}
			if (la(d.floor))
			...
			if (!l && b.tickInterval < m)
				b.tickInterval = m;
			if (!f && !e && !l)
				b.tickInterval = sb(b.tickInterval, null, rb(b.tickInterval), d);
			b.minorTickInterval =
		...
		adjustTickAmount : function () {
			...
			if (c && c[a] && !this.isDatetimeAxis && !this.categories && !this.isLinked && this.options.alignTicks !== !1 && this.min !== r) {
				...
				if (e < a) {
					for (; b.length < a; )
						b.push(ha(b[b.length - 1] + this.tickInterval));
					this.transA *= (e - 1) / (a - 1);
		...
		getOffset : function () {
			...
			if (k || a.isLinked) {
				...
				if (a.horiz && !a.staggerLines && y && !p.rotation) {
					for (s = a.reversed ? [].concat(e).reverse() : e; v < y; ) {
						...
						for (p = 0; p < s.length; p++)
							A = s[p], B = (B = f[A].label && f[A].label.getBBox()) ? B.width : 0, D = p % v, B && (A = a.translate(A), k[D] !== r && A < k[D] && (z = !0), k[D] = A + B);
						if (z)
							v++;
						else
							break
				...
				q(e, function (b) {
					if (h === 0 || h === 2 || {
						...
						[h] === a.labelAlign)
						u = w(f[b].getLabelSize(), u)
				});
				if (a.staggerLines)
					u *= a.staggerLines, a.labelOffset = u
			} else
				for (s in f)
			...
			if (n && n.text && n.enabled !== !1) {
				if (!a.axisTitle)
					...
					a.axisTitle.isNew = !0;
				if (b)
					j = a.axisTitle.getBBox()[g ? "height" : "width"], m = o(n.margin, g ? 5 : 10), l = n.offset;
		...
		render : function () {
					...
					q(a.getMinorTickPositions(), function (b) {
						...
						m[b].render(null, !1, 1)
							...
							if (!h || b >= a.min && b <= a.max)
								l[b] || (l[b] = new Za(a, b)) , x && l[b].isNew && l[b].render(c, !0, 0.1), l[b].render(c, !1, 1)
			...
			if (G)
				b = a.getLinePath(G), a.axisLine ? a.axisLine.animate({
					d : b
		...
		drawCrosshair : function (a, b) {
			if (this.crosshair)
				if ((t(b) || !o(this.crosshair.snap, !0)) === !1)
					this.hideCrosshair();
				else {
					var c,
					d = this.crosshair,
		...
		if (t(b)) {
			...
			if (k >= H.minute)
				i[Nb](k >=
					H.hour ? 0 : j * S(i[ub]() / j));
			if (k >= H.hour)
				i[Ob](k >= H.day ? 0 : j * S(i[vb]() / j));
			if (k >= H.day)
				i[xb](k >= H.month ? 1 : j * S(i[Ua]() / j));
			k >= H.month && (i[Pb](k >= H.year ? 0 : j * S(i[jb]() / j)), h = i[kb]());
			k >= H.year && (h -= h % j, i[Qb](h));
			if (k === H.week)
				i[xb](i[Ua]() - i[wb]() + o(d, 1));
			b = 1;
	...
	L.prototype.normalizeTimeTickInterval = function (a, b) {
		...
		for (g = 0; g < c.length; g++)
			if (d = c[g], e = H[d[0]], f = d[1], c[g +
					1] && a <= (e * f[f.length - 1] + H[c[g + 1][0]]) / 2)
				break;
	...
	L.prototype.getLogTickPositions = function (a, b, c, d) {
		...
		if (a >= 0.5)
			a = s(a), g = this.getLinearTickPositions(a, b, c);
		else if (a >= 0.08)
		...
		else if (b = oa(b), c = oa(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = sb(a, null, rb(a)), g = xa(this.getLinearTickPositions(a, b, c), Ga), !d)
	...
	Xa.prototype = {
		init : function (a, b) {
			...
			this.pinchDown = [];
			this.lastValidTouch = {};
			if (P.Tooltip && b.tooltip.enabled)
				a.tooltip = new Hb(a, b.tooltip), this.followTouchMove = b.tooltip.followTouchMove;
			this.setDOMEvents()
		},
		...
		runPointActions : function (a) {
			...
			if (d && !this._onDocumentMouseMove)
				this._onDocumentMouseMove = function (a) {
					if (aa[sa])
						aa[sa].pointer.onDocumentMouseMove(a)
				},
		...
		reset : function (a) {
			...
			if (a)
				...
				if (this._onDocumentMouseMove)
					R(B, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
				q(b.axes, function (a) {
					a.hideCrosshair()
				});
				this.hoverX = null
		...
		drag : function (a) {
			...
			if (this.hasDragged > 10) {
				...
				if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !this.selectionMarker)
					this.selectionMarker = b.renderer.rect(h, i, f ? 1 : k, g ? 1 : j, 0).attr({
	...
	if (X.PointerEvent || X.MSPointerEvent) {
		...
		Jb = function (a, b, c, d) {
			a = a.originalEvent || a;
			if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && aa[sa])
				d(a), d = aa[sa].pointer, d[b]({
					type : c,
		...
		v(Xa.prototype, {
			...
			onContainerPointerMove : function (a) {
				Jb(a, "onContainerTouchMove", "touchmove", function (a) {
					...
					if (!ya[a.pointerId].target)
						ya[a.pointerId].target = a.currentTarget
				})
			},
		...
		O(Xa.prototype, "init", function (a, b, c) {
			a.call(this, b, c);
			(this.hasZoom || this.followTouchMove) && E(b.container, {
				"-ms-touch-action" : Y,
				"touch-action" : Y
			})
		});
	...
	pb.prototype = {
		init : function (a, b) {
			...
			this.options = b;
			if (b.enabled)
				c.baseline = I(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = y(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = o(b.symbolWidth, 16), c.pages = [], c.render(), A(c.chart, "endResize", function () {
		...
		renderItem : function (a) {
			...
			if (!q)
				a.legendGroup = c.g("legend-item").attr({
						zIndex : 1
					}).add(this.scrollGroup), G.drawLegendSymbol(this, a), a.legendItem =
	...
	va.prototype = {
		...
		getMargins : function () {
			...
			b = this.axisOffset;
			if (j && !t(d[0]))
				this.plotTop = w(this.plotTop, j + this.options.title.margin + a[0]);
			if (c.display && !e.floating)
				if (i === "right") {
					if (!t(d[1]))
						this.marginRight = w(this.marginRight, c.legendWidth - g + f + a[1])
				} else if (i === "left") {
					if (!t(d[3]))
					...
					if (!t(d[0]))
						this.plotTop = w(this.plotTop, c.legendHeight + h + f + a[0])
				} else if (k === "bottom" && !t(d[2]))
					this.marginBottom = w(this.marginBottom, c.legendHeight - h + f + a[2]);
		...
		setSize : function (a, b, c) {
			...
			if (t(a))
				d.chartWidth = e = w(0, s(a)), d.hasUserSize = !!e;
			if (t(b))
				d.chartHeight = f = w(0, s(b));
			(Ca ? ob : E)(d.container, {
				width : e + "px",
				height : f + "px"
			}, Ca);
		...
		drawChartBox : function () {
			...
			if (j)
				f ? f.animate(x) : this.plotBackground = b.rect(p, u, o, q, 0).attr({
						fill : j
					}).add().shadow(a.plotShadow);
			if (l)
				h ? h.animate(x) : this.plotBGImage = b.image(l, p, u, o, q).add();
			r ? r.animate({
				width : s.width,
				height : s.height
		...
		propFromSeries : function () {
			...
			q(["inverted", "angular", "polar"], function (g) {
				...
				for (e = d && d.length; !f && e--; )
					(c = C[d[e].type]) && c.prototype[g] && (f = !0);
				a[g] = f
			})
		},
		linkSeries : function () {
			...
			q(b, function (b) {
				...
				if (Oa(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d)))
	...
	K.prototype = {
			...
			if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData)
				...
				if (p && h > p) {
					...
					if (la(j)) {
						...
						if (G)
							for (c = 0; c < h; c++)
								i = a[c], u[c] = i[0], s[c] = i.slice(1, G + 1);
						else
							for (c =
									0; c < h; c++)
								i = a[c], u[c] = i[0], s[c] = i[1];
					else
						qa(12)
				} else
					for (c = 0; c < h; c++)
						if (a[c] !== r && (i = {
									series : e
								}, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), m && i.name))
							l.names[i.x] = i.name;
				Oa(s[0]) && qa(14, !0);
				e.data = [];
				e.options.data = a;
		...
		processData : function (a) {
			...
			if (l && this.sorted && (!k || d > k || this.forceCrop))
				if (m = h.min, n = h.max, b[d - 1] < m || b[0] > n)
					b = [], c = [];
				else if (b[0] < m || b[d - 1] > n)
					e = this.cropData(this.xData, this.yData, m, n), b = e.xData, c = e.yData, e = e.start, f = !0, j = b.length;
			for (d = b.length - 1; d >= 0; d--)
				a = b[d] - b[d - 1], !f && b[d] > m && b[d] < n && j++, a > 0 && (g === r || a < g) ? g = a : a < 0 && this.requireSorting && qa(15);
			this.cropped = f;
			this.cropStart = e;
			this.processedXData =
				b;
		...
		generatePoints : function () {
			...
			for (m = 0; m < g; m++)
				i = h + m, k ? l[m] = (new f).init(this, [d[m]].concat(ma(e[m]))) : (b[i] ? j = b[i] : a[i] !== r && (b[i] = j = (new f).init(this, a[i], d[m])), l[m] = j);
			if (b && (g !== (c = b.length) || k))
				for (m = 0; m < c; m++)
					if (m === h && !k && (m += g), b[m])
						b[m].destroyElements(), b[m].plotX = r;
			this.data = b;
			this.points = l
		},
		...
		translate : function () {
			...
			for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement,
				...
				if (b && this.visible && u && u[m])
					u = u[m], n = u.points[this.index + "," + a], p = n[0], n = n[1], p === 0 && (p = o(j, e.min)), e.isLog && p <= 0 && (p = null), l.total = l.stackTotal = u.total, l.percentage = u.total && l.y / u.total * 100, l.stackY = n, u.setOffset(this.pointXOffset || 0, this.barW || 0);
			...
			if (d.enabled !== !1 || this._hasPointMarkers)
				for (f = b.length; f--; )
					if (g = b[f], d = S(g.plotX), e = g.plotY, j = g.graphic, i = g.marker || {}, a = p && i.enabled === r || i.enabled, m = c.isInsidePlot(s(d), e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null)
						if (a =
								g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = o(i.symbol, this.symbol), k = i.indexOf("url") === 0, j)
							j[m ? "show" : "hide"](!0).animate(v({
									x : d - h,
									y : e - h
								}, j.symbolName ? {
									width : 2 * h,
		...
		destroy : function () {
			...
			q(a.axisTypes || [], function (b) {
				if (i = a[b])
					pa(i.series, a), i.isDirty = i.forceRedraw = !0
			});
	...
	K.prototype.setStackedPoints = function () {
		if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
			...
			for (o = 0; o < d; o++) {
				...
				l[p] || (l[p] = {});
				if (!l[p][q])
					m[p] && m[p][q] ? (l[p][q] = m[p][q], l[p][q].total = null) : l[p][q] = new Rb(j, j.options.stackLabels, n, q, g);
				p = l[p][q];
				p.points[u] = [p.cum || 0];
		...
		q([b, "-" + b], function (b) {
			...
			for (var f = d.length, g, h; f--; )
				if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index + "," + f], g = e)
					h = h.total ? 100 / h.total : 0, g[0] = ha(g[0] * h), g[1] = ha(g[1] * h), a.stackedYData[f] = g[1]
		})
	};
	v(va.prototype, {
	...
	var ta = ga(K, {
			...
			getSegments : function () {
				...
				if (this.options.stacking && !this.cropped) {
					...
					K.prototype.getSegments.call(this), a = this.segments;
				this.segments = a
			},
			getSegmentPath : function (a) {
			...
			drawPoints : function () {
				...
				q(a.points, function (i) {
					...
					if (k !== r && !isNaN(k) && i.y !== null)
						f = i.shapeArgs, h = t(a.borderWidth) ? {
							"stroke-width" : a.borderWidth
						}
					 : {},
					g = i.pointAttr[i.selected ? "select" :
							""] || a.pointAttr[""],
	...
	K.prototype.drawDataLabels = function () {
		...
		if (d.enabled || a._hasPointLabels)
			a.dlProcessOptions && a.dlProcessOptions(d), i = a.plotGroup("dataLabelsGroup", "data-labels", "hidden", d.zIndex || 6), !a.hasRendered && o(d.defer, !0) && (i.attr({
					opacity : 0
				}), A(a, "afterAnimate", function () {
	...
	if (C.pie)
		C.pie.prototype.drawDataLabels = function () {
			...
			if (a.visible && (e.enabled || a._hasPointLabels)) {
				...
				for (B = 0; !t && b[B]; )
					t = b[B] && b[B].dataLabel && (b[B].dataLabel.getBBox().height || 21), B++;
				for (B = 2; B--; ) {
					var b = [],
					H = [],
					C = v[B],
					...
					if (l >
						...
						for (D = 0; D < E; D++) {
							...
							J;
							for (J = 0; J < G; J++)
								L = M(b[J] - x[1]), L < c && (c = L, F = J);
							if (F < D && b[D] !== null)
								F = D;
							else
								for (G < E - D + F && b[D] !== null && (F = G - E + D); b[F] === null; )
									F++;
							H.push({
								i : F,
								y : b[F]
					...
					for (D = 0; D < E; D++) {
						...
						if (l > 0) {
							if (G = H.pop(), F = G.i,
								z = G.y, c > z && b[F + 1] !== null || c < z && b[F - 1] !== null)
								z = c
						} else
							z = c;
						...
						if (this.options.size === null)
							G = r.width, y - G < f ? U[3] = w(s(G - y + f), U[3]) : y + G > h - f && (U[1] = w(s(y + G - h + f), U[1])), z - t / 2 < 0 ? U[0] = w(s(-z + t / 2), U[0]) : z + t / 2 > d && (U[2] = w(s(z + t / 2 - d), U[2]))
					}
				}
				if (Ba(U) === 0 || this.verifyDataLabelOverflow(U))
					this.placeDataLabels(), u && g && q(this.points, function (b) {
						...
						if ((r = b.dataLabel) && r._pos)
							A = r._attr.visibility, y = r.connX, z = r.connY, k = j ? ["M", y + (x[6] === "left" ? 5 : -5), z, "C", y, z, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", y + (x[6] === "left" ? 5 : -5), z, "L", x[2], x[3], "L", x[4], x[5]], i ? (i.animate({
									d : k
	...
	if (C.column)
		Aa.prototype.drawTracker = gb.drawTrackerPoint;
	if (C.pie)
		C.pie.prototype.drawTracker = gb.drawTrackerPoint;
	if (C.scatter)
		ta.prototype.drawTracker = gb.drawTrackerPoint;
	v(pb.prototype, {
	...
	v(za.prototype, {
		select : function (a, b) {
			...
			c.firePointEvent(a ? "select" :
				...
				b || q(e.getSelectedPoints(), function (a) {
					if (a.selected && a !== c)
						a.selected = a.options.selected = !1, d.options.data[wa(a, d.data)] = a.options, a.setState(""), a.firePointEvent("unselect")
				})
			})
		},
		...
		setState : function (a, b) {
			...
			if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
				if (this.graphic)
					g = g && this.graphic.symbolName && p.r, this.graphic.attr(y(p, g ? {
							x : c - g,
							y : d - g,
							width : 2 * g,
							height : 2 * g
					...
					if (a && i)
						if (g = i.radius, l = l.symbol || e.symbol, j && j.currentSymbol !==
							...
							e.stateMarkerGraphic = j = m.renderer.symbol(l, c - g, d - g, 2 * g, 2 * g).attr(p).add(e.markerGroup), j.currentSymbol = l;
					if (j)
			...
			if (!(this.options.enableMouseTracking === !1 || this.singularTooltips)) {
				...
				for (i = 0; i < a; i++)
					if (e = b[i], c = e.x, c >= f.min && c <= f.max) {
						h = b[i + 1];
						c = d === r ? 0 : d + 1;
						for (d = b[i + 1] ? z(w(0, S((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g; c >= 0 && c <= d; )
							k[c++] = e
					}
	...
	O(L.prototype, "getTimeTicks", function (a, b, c, d, e, f, g, h) {
		...
		if (h && a.unitRange <= H.hour) {
			k = o.length - 1;
			for (i = 1; i < k; i++)
				(new Date(o[i] - La))[Ua]() !== (new Date(o[i - 1] - La))[Ua]() && (l[o[i]] = "day", m = !0);
			m && (l[o[0]] = "day");
			a.higherRanks = l
		}
		o.info = a;
		if (h && t(s)) {
			...
			x;
			for (m = []; h--; )
				i = this.translate(o[h]), x && (m[h] = x - i), k[h] = x = i;
			m.sort();
			m = m[S(m.length / 2)];
			m < s * 0.6 && (m = null);
			h = o[a - 1] > d ? a - 1 : a;
			for (x = void 0; h--; )
				i = k[h], d = x - i, x && d < s * 0.8 && (m === null || d < m * 0.8) ? (l[o[h]] && !l[o[h + 1]] ? (d = h + 1, x = i) : d = h, o.splice(d, 1)) : x = i
		}
		return o
	});
	v(L.prototype, {
		...
		lin2val : function (a, b) {
			...
			if (c) {
				...
				h;
				if (b)
					a < 0 ? a = c[0] : a > f ? a = c[f] : (f = S(a), h = a - f);
				else
					for (; f--; )
						if (g = d * f + e, a >= g) {
							d = d * (f + 1) + e;
		...
		if (c.options.ordinal && c.series.length) {
			...
			if (m.ordinalPositions) {
				if (M(f) > 1)
					...
					this.fixedRange = k - i, f = c.toFixedRange(null, null, l.apply(j, [n.apply(j, [i, !0]) + f, !0]), l.apply(p, [n.apply(p, [k, !0]) + f, !0])), f.min >= z(g.dataMin, i) && f.max <= w(h, k) && c.setExtremes(f.min, f.max, !0, !1, {
						trigger : "pan"
	...
	ba.groupData = function (a, b, c, d) {
		...
		for (; o <= i; o++) {
			for (; c[1] !== r && a[o] >= c[1] || o === i; )
				if (k = c.shift(), j = d.apply(0, m), j !== r && (g.push(k), h.push(j)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], o === i)
					break;
			if (o === i)
				break;
			if (n) {
				...
				var q;
				for (j = 0; j < p; j++)
					if (q = k[n[j]], typeof q === "number")
						m[j].push(q);
					else if (q === null)
						m[j].hasNulls =
							!0
			} else if (k = l ? b[o] : null, typeof k === "number")
				m[0].push(k);
			else if (k === null)
				m[0].hasNulls = !0
		}
	...
	O(ba, "setOptions", function (a, b) {
		...
		f = T[d].dataGrouping;
		if (Wb[d])
			f || (f = y(lc, Wb[d])), c.dataGrouping = y(f, e.series && e.series.dataGrouping, e[d].dataGrouping, b.dataGrouping);
			...
			drawPoints : function () {
				...
				q(a.points, function (j) {
					if (j.plotY !== r)
						...
						null && (d = s(j.plotOpen) + f, h.push("M", k, d, "L", k - g, d)), j.close !== null && (e = s(j.plotClose) + f, h.push("M", k, e, "L", k + g, e)), i ? i.animate({
							d : h
				...
				q(a.points, function (o) {
					...
					if (o.plotY !== r)
						c = o.pointAttr[o.selected ? "selected" : ""] || d, j = c["stroke-width"] % 2 / 2, l = s(o.plotX) - j, e = o.plotOpen, f = o.plotClose, g = V.min(e,
								f), h = V.max(e, f), p = s(o.shapeArgs.width / 2), i = s(g) !== s(o.plotY), k = h !== o.yBottom, g = s(g) + j, h = s(h) + j, n = ["M", l - p, h, "L", l - p, g, "L", l + p, g, "L", l + p, h, "Z", "M", l, g, "L", l, i ? s(o.plotY) : g, "M", l, h, "L", l, k ? s(o.yBottom) : h, "Z"], m ? m.animate({
							d : n
				...
				if (d && d.visible && h) {
					...
					for (b.sort(function (a, b) {
						...
						if (d = b[c], j = g[h], j.x <= d.x && j.plotY !== r) {
							if (d.x <= l)
								d.plotY = j.plotY, j.x < d.x && !f && (m = g[h + 1]) && m.plotY !== r && (d.plotY += (d.x - j.x) / (m.x - j.x) * (m.plotY - j.plotY));
							c--;
							h++;
							if (c < 0)
								break
			...
			drawPoints : function () {
				...
				for (k = c.length; k--; )
					if (j = c[k], a = j.plotX > this.xAxis.len, e = j.plotX + (a ? m : -m), l = j.stackIndex, i = j.options.shape || g.shape, f = j.plotY, f !== r && (f = j.plotY + h + m - (l !== r && l * g.stackDistance)), n = l ? r : j.plotX + m, o = l ? r : j.plotY, l = j.graphic, f !== r &&
						e >= 0 && !a)
						a = j.pointAttr[j.selected ? "select" : ""] || b, l ? l.attr({
							x : e,
							y : f,
							r : a.r,
							anchorX : n,
	...
	yb.prototype = {
		drawHandle : function (a, b) {
			...
			h;
			this.rendered || (f[b] =
					d.g("navigator-handle-" + ["left", "right"][b]).css({
						cursor : "e-resize"
					}).attr({
						zIndex : 4 - b
			...
			if (!isNaN(a)) {
				...
				if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
					...
					if (!this.rendered) {
						...
						if (q)
							this.scrollbarGroup = j = f.g("scrollbar").add(), m = t.trackBorderWidth, this.scrollbarTrack = n = f.rect().attr({
									x : 0,
									y : -m % 2 / 2,
					...
					if (q && j)
						this.drawScrollbarButton(0), this.drawScrollbarButton(1), j[e]({
							...
							width : k
						}), g = p + b, h = a - H, h < x && (F = (x - h) / 2, h = x, g -= F), this.scrollbarPad = F, m[e]({
							x : S(g) + H % 2 / 2,
							width : h
						}), x = p + b + a / 2 - 0.5, this.scrollbarRifles.attr({
		...
		init : function () {
			...
			a.mouseDownHandler = function (d) {
				...
				w = cb ? 10 : 7;
				if (t > h && t < h + g + k)
					if ((h = !a.scrollbarEnabled || t < h + g) && V.abs(s - e - o) < w)
						...
						if (f < 0)
							...
							f = p - r, v = c.dataMax;
						if (f !== e)
							a.fixedWidth = r, e = c.toFixedRange(f, f + r, null, v), d.setExtremes(e.min, e.max, !0, !1, {
								trigger : "navigator"
							})
					}
			};
		...
		addBaseSeries : function () {
			...
			if (a && this.navigatorOptions.adaptToUpdatedData !== !1)
				A(a, "updatedData", this.updatedDataHandler), a.userOptions.events = v(a.userOptions.event, {
		...
		updatedDataHandler : function () {
			...
			if (!a.hasNavigatorData)
				n.options.pointStart = b.xData[0], n.setData(b.options.data, !1), m = !0;
			i && (l = g, j = l + h);
	...
	O(L.prototype, "zoom", function (a, b, c) {
		...
		if (this.isXAxis && (g && g.enabled || e && e.enabled))
			if (f === "x")
				...
				d = this.previousZoom, t(b) ? this.previousZoom = [this.min, this.max] : d && (b = d[0], c = d[1], delete this.previousZoom);
	...
	zb.prototype = {
		...
		drawInput : function (a) {
			...
			this[a + "Label"] = k = e.label(F.lang[h ? "rangeSelectorFrom" :
						"rangeSelectorTo"], this.inputGroup.offset).attr({
					padding : 2
	...
	P.StockChart = function (a, b) {
		var c = a.series,
		d,
		e = o(a.navigator && a.navigator.enabled, !0) ? {
			startOnTick : !1,
			endOnTick : !1
		}
		 : null,
	...
	ka.prototype.crispPolyLine = function (a, b) {
		...
		for (c = 0; c < a.length; c += 6)
			a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = s(a[c + 1]) - b % 2 / 2), a[c + 2] === a[c + 5] && (a[c + 2] = a[c + 5] = s(a[c + 2]) + b % 2 / 2);
		return a
	};
	if (Wa === P.VMLRenderer)
		fb.prototype.crispPolyLine = ka.prototype.crispPolyLine;
	...
	ba.setCompare = function (a) {
		this.modifyValue = a === "value" || a === "percent" ? function (b, c) {
			...
			if (b !== r && (b = a === "value" ? b - d : b = 100 * (b / d) - 100, c))
				c.change = b;
			return b
		}
		 : null;
	...
	O(K.prototype, "render", function (a) {
		if (this.isCartesian && this.chart.options._stock)
			this.clipBox ? this.chart[this.sharedClipKey] && this.chart[this.sharedClipKey].attr({
